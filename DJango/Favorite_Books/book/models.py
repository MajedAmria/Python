...
class BlogManager(models.Manager):
    ...
    def book_validator(self,postData): 
         ...
         if len(postData['title']) < 5:
            errors["title"] = "less than 5 must be above"
         if len(postData['desc']) < 5:
            errors["desc"] = "less than 5 must be above"
         return errors
...
class Book(models.Model):
    ...
    book_upload=models.ForeignKey(User,related_name="books",on_delete=models.CASCADE)
